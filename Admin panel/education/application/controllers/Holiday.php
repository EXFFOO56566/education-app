...
class Holiday extends CI_Controller {
 ...
 function send_gcm()
 {
    $this->load->helper('gcm_helper');
                $gcm = new GCM();
                $registatoin_ids = array("eTAX_MFw8Y0:APA91bGBWC6C6A5mF_JtjZ6Pa3Rn3qqIk0-_Zl5JYN4jxVBuw2d8BpCg2cxGqmhKLqbKwO0-zft8hV__CYTg3GYGehhsY9uqjjbKzP_UwzMSmrWN99biQ6coJBSPK4sUPx4bumwaYXP6");
